...
export const routes: Routes = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'users', loadComponent: () => import('./admin/users/users.component').then(m => m.UsersListComponent) },
      {
        path: 'participants/:id', loadComponent: () =>
          import('./admin/participations/participations.component')
